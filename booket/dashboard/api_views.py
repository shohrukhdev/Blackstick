...
from booket.notifications import notify_client_status_change
    ...
    def update_appointment(self, request, pk=None):
        ...
        try:
            ...
            if action_type == 'save_note':
                ...
                appointment.comment_by_server = comment_by_server
                appointment.save()
                notify_client_status_change(appointment, 'reschedule')
                ...
                appointment.comment_by_server = comment_by_server
                appointment.save()
                notify_client_status_change(appointment, 'accept')
                ...
                appointment.comment_by_server = comment_by_server
                appointment.save()
                notify_client_status_change(appointment, 'reject')
                ...
                appointment.comment_by_server = comment_by_server
                appointment.save()
                notify_client_status_change(appointment, 'cancel')
